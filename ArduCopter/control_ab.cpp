...
//Isay The first flight mode we will work on.
// loiter_init - initialise loiter controller
bool Copter::ab_init(bool ignore_checks)
{
    if (position_ok() || ignore_checks) {

        // set target to current position 
        wp_nav->init_loiter_target(); //Isay: This should be changed to two positions and a heading
...
/*
#if PRECISION_LANDING == _precision_loiter_enabled        //Isay no landing nescessary in this flight mode.
...
#endif//Isay    Currently not important.
